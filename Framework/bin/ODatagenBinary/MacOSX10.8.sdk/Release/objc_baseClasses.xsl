...
/* This generator was edited by Elizabeth Duncan to be compliant with iOS 6.1 
   Continuum 2013
*/
...
<xsl:for-each select="schema_1_0:Property | schema_1_1:Property | schema_1_2:Property">
<xsl:comment> POTENTIAL COLON PLACEMENT!!! </xsl:comment>
...
<xsl:comment> Insert colon before ')' to comply with stricter xCode syntax </xsl:comment>
